...
const Footer = () => {
  return (
    <VStack bg="#9DC3DA" color={"white"} alignItems="center" gap="40px" p="100px 0">
      <Heading fontSize={{md:"40px", sm:"30px", base:"24px"}}>JOIN NEWSLETTER</Heading>
      <HStack alignSelf="center" w={{xl:"40%", lg:"50%", sm:"80%", base:"90%"}}>
        <Input
        bg="white"
      ...
      flexDirection={{md:"row", base:"column"}}
        ...
        padding="10px"
      >
        <Image src="/assets/agi.png" width={{lg:"200px", md:"100px", base:"100px"}} />

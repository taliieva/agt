  ...
  return (
    <HStack justifyContent="center" gap="40px" p={20}>
      <VStack w="50%" alignItems="flex-start" textAlign="justify">
        ...
        <Button p="10px 30px" bg={"white"} color="#68CE65" border="1px solid #68CE65" cursor="pointer" fontSize="16px" _hover={{color:"white", bg:"#68CE65", borderRadius:"20px", transitionDuration:"1s"}}>Daha çox</Button>
      </VStack>

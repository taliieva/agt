  ...
  return (
    <Box p="30px 0" w="100%" display="flex" alignItems="center" justifyContent="center">
      ...
      >
        ...
        <Grid gridTemplateColumns="repeat(2,1fr)"  gap={10} w="90%">
        ...
        <Button p="10px" w="20%" borderRadius="20px" border={"none"} mt={20} bg="#7F7BE2" color="white" fontSize="16px" cursor="pointer">Gonder</Button>
      </VStack>
    </Box>
  );
};
